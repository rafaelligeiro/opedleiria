...
<div class="container-fluid">
    <div class="row">
        ...
        <div style="margin-top: 20px" class="col-4">
            <div class="card shadow">
                <div class="card-header p-4">
                    <h1 style="display: inline">{{ $count_inscricoes }}</h1>
                    <h3 style="display: inline">Inscricoes</h3>
                </div>
            </div>
        </div>
        <div style="margin-top: 20px" class="col-4">
            <div class="card shadow">
                <div class="card-header p-4">
                    <h1 style="display: inline">{{ $count_patrocinios }}</h1>
                    <h3 style="display: inline">Patrocinios</h3>
                </div>
            </div>
        </div>
    </div>
