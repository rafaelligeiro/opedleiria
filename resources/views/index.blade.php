@extends ('layout.master') @section('title', 'Bem-Vindo ao OPEDLeiria')
@section('styles')
...
<div class="hero-section">
    <div class="content">
        ...
        <p>
            Instituição sem fins lucrativos ao serviço das pessoas<br />
...
<div class="container">
    <div class="linha1">
        <div class="box1">
            <h2>Quem Somos</h2>
            <p>
                Somos a OPEDLeiria, uma associação comprometida com a promoção
                da inclusão e melhoria da qualidade de vida para pessoas com
                deficiência na região de Leiria. Fundada em 2023, a nossa missão
                é criar uma comunidade inclusiva onde cada indivíduo é
                valorizado, respeitado e capacitado.
            </p>
            <button class="button-sec">Saber Mais</button>
        </div>
        <div class="box2">
    ...
    <div class="linha2">
        <div class="box2">
            ...
            <p>
                Trabalhamos incansavelmente para proporcionar oportunidades para
                que pessoas com deficiência alcancem o seu pleno potencial.
                Acreditamos na igualdade de direitos e na construção de uma
                sociedade mais justa e acessível.
            </p>
        </div>
        <div class="box1">
            <div class="content">
                <h2>Como Ajudar</h2>
                <p>
                    A sua doação faz toda a diferença na construção de um
                    ambiente mais inclusivo e acolhedor para pessoas com
                    deficiência na nossa comunidade.
                </p>
    ...
    <div class="linha3">
        <div class="box1">
            <div class="content">
                <h2>
                    Como sempre, estamos abertos a receber novos membros na
                    nossa assossiação
                </h2>
                <p>
                    Seja de que lugar do mundo for, todos são bem-vindos na
                    OPEDLeiria. Junte-se a nós para construir uma comunidade
            ...
            <div class="content">
                ...
                <div>
                    <div class="boxes">
                        <div class="box">
                            <p class="cima">
                                {{ \Carbon\Carbon::parse($evento->data)->format('H:i') }}
                            </p>
                            <p class="meio">
                                {{ \Carbon\Carbon::parse($evento->data)->format('d') }}
                            </p>
                            <p class="baixo">
                                {{ \Carbon\Carbon::parse($evento->data)->format('F') }}
                            </p>
                        </div>
                        <div class="box">
